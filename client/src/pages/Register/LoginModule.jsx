...
import { Form, Title, ButtonContainer, RedirectLink } from "./styled";
//............................
const Error = styled.span`
	color: red;
`;

export default function LoginModule({ noRedirect }) {
	...
	return (
		<Form>
			...
			<TextField className="mb-3 w-100" type="password" value={password} onChange={(e) => setPassword(e.target.value)} id="standard-basic" label="Password" variant="standard" />
			<ButtonContainer>
